...
QString ViewSettings::leIpAddr() const
{
    return m_leIpAddr;
}

void ViewSettings::setLeIpAddr(QString leIpAddr)
{
    if (m_leIpAddr == leIpAddr)
        return;

    m_leIpAddr = leIpAddr;
    emit leIpAddrChanged(m_leIpAddr);
}

int ViewSettings::comNumber() const
{
    return m_comNumber;
}

void ViewSettings::setComNumber(int comNumber)
{
    if (m_comNumber == comNumber)
        return;

    m_comNumber = comNumber;
    emit comNumberChanged(m_comNumber);
}
