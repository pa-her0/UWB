...
class ViewSettings : public QObject
{
    ...
    Q_PROPERTY(QString leIpAddr READ leIpAddr WRITE setLeIpAddr NOTIFY leIpAddrChanged)
    Q_PROPERTY(int comNumber READ comNumber WRITE setComNumber NOTIFY comNumberChanged)
...
public:
    ...
    QString leIpAddr() const;
    void setLeIpAddr(QString leIpAddr);
...
signals:
    ...
    void leIpAddrChanged(QString leIpAddr);
