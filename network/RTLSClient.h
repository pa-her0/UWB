...
public:
    ...
    void updateTagLog(int rangetime);
...
signals:
    ...
    void tagRange(quint64 tagId, quint64 aId, double x, double y, int alarm);
...
private:
    ...
    QList <QString> _csvLogFilePathList;
    QList <QFile *> _fileCSVList;
